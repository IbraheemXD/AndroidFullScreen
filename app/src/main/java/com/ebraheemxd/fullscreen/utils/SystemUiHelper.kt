 ...
 * or [.toggle].
 */
class SystemUiHelper @JvmOverloads constructor(
    activity: Activity, level: Int, flags: Int,
    listener: OnVisibilityChangeListener? = null
) {
    private var mImpl: SystemUiHelperImpl? = null
